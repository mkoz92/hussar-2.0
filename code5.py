...
if __name__ == "__main__":
    ...
    while True:
        ...
        strip1.fill(rainbowio.colorwheel(supervisor.ticks_ms() // 4))
        strip2.fill(rainbowio.colorwheel(supervisor.ticks_ms() // 4))
        strip3.fill(rainbowio.colorwheel(supervisor.ticks_ms() // 4))
