...
if __name__ == "__main__":
    ...
    NUM_PIXELS = 5
    strip1 = NeoPixelBackground(board.NEOPIXEL0, NUM_PIXELS)[-2:]
    strip2 = NeoPixelBackground(board.NEOPIXEL1, NUM_PIXELS)[-2:]
    strip3 = NeoPixelBackground(board.NEOPIXEL2, NUM_PIXELS)[-2:]
